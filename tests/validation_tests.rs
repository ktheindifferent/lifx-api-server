...
mod validation_tests {
    ...
    fn test_invalid_brightness_values() {
        ...
        for (value, description) in invalid_values {
            ...
            let result: Result<StateUpdate, _> = serde_json::from_str(&json);
            assert!(result.is_err(), "Should reject brightness {} ({})", value, description);
        }
    }
    ...
    fn test_invalid_infrared_values() {
        ...
        for (value, description) in invalid_values {
            ...
            let result: Result<StateUpdate, _> = serde_json::from_str(&json);
            assert!(result.is_err(), "Should reject infrared {} ({})", value, description);
        }
    }
    ...
    fn test_invalid_duration_values() {
        ...
        for (value, description) in invalid_values {
            ...
            let result: Result<StateUpdate, _> = serde_json::from_str(&json);
            assert!(result.is_err(), "Should reject duration {} ({})", value, description);
        }
    }
    ...
    fn test_invalid_power_values() {
        ...
        let invalid_values = vec!["ON", "OFF", "true", "false", "1", "0", "enabled", "disabled"];
    ...
    fn test_multiple_invalid_fields() {
        ...
        let result: Result<StateUpdate, _> = serde_json::from_str(json);
        assert!(result.is_err(), "Should reject when multiple fields are invalid");
    }
